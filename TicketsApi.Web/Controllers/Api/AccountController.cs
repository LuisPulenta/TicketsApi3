    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<IActionResult> RecoverPassword(RecoverPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                _mailHelper.SendMailSinCc(model.Email, "Tickets - Reseteo de contraseña", $"<h1>Tickets - Reseteo de contraseña</h1>" +
        ...
        private async Task<IActionResult> SendConfirmationEmailAsync(User user)
        {
            ...
            _mailHelper.SendMailSinCc(user.Email, "Tickets - Confirmación de cuenta", $"<h1>Tickets - Confirmación de cuenta</h1>" +
